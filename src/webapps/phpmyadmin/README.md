...
```Dockerfile
FROM shinsenter/phpmyadmin:latest
...
# For example:
# ADD --chown=$APP_USER:$APP_GROUP ./phpmyadmin/ /var/www/html/
```
...
such as `your-repo/phpmyadmin:stable` using the below commands:
