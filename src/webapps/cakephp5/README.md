...
🔋 (PHP / CakePHP) Production-ready Docker images with automatic CakePHP installer.

- Docker Hub: https://hub.docker.com/r/shinsenter/cakephp5
- GitHub Packages: https://code.shin.company/php/pkgs/container/cakephp5
...
```Dockerfile
FROM shinsenter/cakephp5:latest
...
But you can pull the image from `shinsenter/cakephp5:latest`,
and tag it with a name that indicates its stability,
such as `your-repo/cakephp5:stable` using the below commands:

```shell
docker pull shinsenter/cakephp5:latest
docker tag  shinsenter/cakephp5:latest your-repo/cakephp5:stable
docker push your-repo/cakephp5:stable
```

Then use the image `your-repo/cakephp5:stable` as a base image to build containers for production.
