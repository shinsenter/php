...
🔋 (PHP / Grav) Production-ready container with automatic Grav installer.

- Docker Hub: https://hub.docker.com/r/shinsenter/grav
- GitHub Packages: https://github.com/shinsenter/php/pkgs/container/grav
...
such as `shinsenter/grav:stable` using the below commands:
