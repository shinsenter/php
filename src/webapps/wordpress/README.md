...
docker tag  shinsenter/wordpress:latest your-repo/wordpress:stable
docker push your-repo/wordpress:stable
```

Then use the image `your-repo/wordpress:stable` as a base image to build containers for production.
