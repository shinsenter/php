...
🔋 (PHP / Kirby) Production-ready container with automatic Kirby installer.

- Docker Hub: https://hub.docker.com/r/shinsenter/kirby
- GitHub Packages: https://github.com/shinsenter/php/pkgs/container/kirby
...
such as `shinsenter/kirby:stable` using the below commands:
