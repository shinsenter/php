...
🔋 (PHP / PHPixie) Production-ready container with automatic PHPixie installer.

- Docker Hub: https://hub.docker.com/r/shinsenter/phpixie
- GitHub Packages: https://github.com/shinsenter/php/pkgs/container/phpixie
...
such as `shinsenter/phpixie:stable` using the below commands:
