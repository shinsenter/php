...
env-default PHP_DISPLAY_ERRORS '$(is-debug && echo 1 || echo 0)'
env-default PHP_ERROR_LOG '$(log-path stderr)'
env-default PHP_ERROR_REPORTING '$(is-debug && echo '\''E_ALL'\'' || echo '\''E_ALL & ~E_STRICT & ~E_DEPRECATED & ~E_USER_DEPRECATED'\'')'
env-default PHP_EXPOSE_PHP '$(is-debug && echo 1 || echo 0)'
env-default PHP_FASTCGI_LOGGING 'Off'
env-default PHP_MAIL_LOG '${SMTP_LOG:=$(log-path stdout)}'
env-default PHP_MEMORY_LIMIT '256M'
env-default PHP_OPCACHE_ENABLE '1'
env-default PHP_OPCACHE_ERROR_LOG '$(log-path stderr)'
...
env-default PHP_OPCACHE_PRELOAD_USER '$APP_USER'
...
env-default PHP_SENDMAIL_PATH '$(command -v sendmail) -t'
...
env-default PHP_PM_PROCESS_IDLE_TIMEOUT '10'
