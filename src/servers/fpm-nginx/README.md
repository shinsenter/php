...
If you have your `index.php` file located in a `public` directory within your `$WEBHOME` path, you can also change the default document directory of Nginx by using the `$NGINX_DOCUMENT_ROOT` environment variable.
